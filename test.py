...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov4x-mish.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/wildfire.yaml', help='*.data path')
